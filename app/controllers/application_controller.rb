class ApplicationController < ActionController::Base
  ...
  def current_user
    ...
    elsif cookies.permanent.signed[:remeber_me_token]
      verification = Rails.application.message_verifier(:remeber_me).verify(cookies.permanent.signed[:remeber_me_token])
      if verification
        Rails.logger.info "Logged in by cookie"
